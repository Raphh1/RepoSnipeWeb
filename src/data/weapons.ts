...
export const WEAPONS: WeaponData[] = [
  ...
  w('Couteau de rue',             1,  6, 14,  8, 'poison',      15, 'Lame sale — empoisonne 5-10 dégâts/tour ×4',  0,  0, { Vagabond: 1.15, Contrebandier: 1.1 }),
  w('Matraque de garde',          1,  8, 16,  6, 'stun',       20, 'Étourdit l\'ennemi 1 tour',                  0,  0, { 'Seigneur de guerre': 1.15 }),
  w('Pistolet rouillé',           1,  7, 15, 10, 'burn',        18, 'Poudre instable — brûle 8-15 dégâts/tour ×3', 8, 10),
  ...
  w('Pique artisanale',           1,  7, 14,  7, 'armorPierce',  0, 'Pointe acérée — +30% dégâts (perce l\'armure)', 0, 0),
  ...
  w('Pistolet semi-auto',         2, 12, 24, 12, 'double_strike',0, 'Tir en rafale — frappe deux fois (×0.85 chacune)', 0, 0),
  w('Fusil à impulsion',          2, 14, 28, 14, 'blind',      25, 'Aveugle l\'ennemi (-40% précision)',          0,  0, { Hackeur: 1.2 }),
  w('Lame vibrante',              2, 15, 30, 16, 'armorPierce',  0, 'Vibrations ultrasoniques — +30% dégâts (perce l\'armure)', 0, 0, { 'Seigneur de guerre': 1.2, Vétéran: 1.15 }),
  ...
  w('Revolver Scav modifié',      2, 13, 27, 18, 'distraction', 20, 'Détonation assourdissante — distrait l\'ennemi', 0, 0, { Contrebandier: 1.15, Vagabond: 1.1 }),
  ...
  w('Fusil à pompe galactique',   3, 22, 45, 18, 'stun',        35, 'Impact dévastateur — étourdit l\'ennemi 1 tour', 15, 18, { 'Seigneur de guerre': 1.2, Vétéran: 1.2 }),
  ...
  w('Fusil de sniper portatif',   3, 26, 52, 25, 'silence',     40, 'Tir de suppression — limite l\'ennemi aux attaques basiques ×2 tours', 0, 0, { Vétéran: 1.15 }),
  ...
  w('Gatling à plasma Bonne Nuit',4, 30, 60, 20, 'burn',        45, 'Pluie de plasma — brûle 12-20 dégâts/tour ×3', 25, 25, { 'Seigneur de guerre': 1.2 }),
  ...
  w('Fusil de précision Céleste', 4, 34, 68, 32, 'silence',     50, 'Tir chirurgical — réduit l\'ennemi au silence ×2 tours', 0, 0, { Vétéran: 1.2 }),
